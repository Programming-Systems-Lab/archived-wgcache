  ...
  public void run() 	{
    ...
    HttpReplyHdr   reply   = new HttpReplyHdr();
      ...
      //
          ...
          SrvrSocket = new Socket(config.getFatherProxyHost(),config.getFatherProxyPort());
				}
				else {
          ...
          request.url = serverUrl(request.url);
				...
				DataOutputStream srvOut = new DataOutputStream(SrvrSocket.getOutputStream());
				//
